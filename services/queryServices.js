    ...
    const insertIntoProducts = async () =>{
        try {
            ...
            if (rowCount === 0) {
                ...
                console.log('Data already exists in products table');
                return false; // Data insertion skipped
            }
        } catch (error) {
            console.log(error);
